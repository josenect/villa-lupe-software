    ...
    <div class="col-12 col-md-8 col-lg-6">
        <div class="card-custom fade-in">
            <div class="card-header-custom" style="background: linear-gradient(135deg, #e67e22, #d35400);">
                <h2><i class="bi bi-person-gear"></i> Datos del Cliente</h2>
            </div>
            <div class="card-body-custom">
                ...
                <form action="{{ route('domicilios.update', $domicilio->id) }}" method="POST">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" name="cliente_nombre" class="form-control-custom" value="{{ old('cliente_nombre', $domicilio->cliente_nombre) }}" placeholder="Nombre completo" required autofocus>
                    </div>

                    <div class="mb-3">
                        <label class="form-label-custom"><i class="bi bi-telephone"></i> Telefono</label>
                        <input type="text" name="cliente_telefono" class="form-control-custom" value="{{ old('cliente_telefono', $domicilio->cliente_telefono) }}" placeholder="Numero de telefono" required>
                    </div>

                    <div class="mb-3">
                        <label class="form-label-custom"><i class="bi bi-geo-alt"></i> Direccion</label>
                        <input type="text" name="cliente_direccion" class="form-control-custom" value="{{ old('cliente_direccion', $domicilio->cliente_direccion) }}" placeholder="Direccion de entrega" required>
                    </div>
