                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                @endif
                                 ...
                                 @if($productosTable->count() > 0)
                                    <a target="_black" href="#" id="generar-factura-btn" data-mesa-id="{{ $mesa->id }}" class="btn-gene-factu">Generar Factura</a>
                                  @else
                                    <a target="_black" href="/generar-factura/{{ $mesa->id }}" class="btn-gene-factu">Ver Ultima Factura</a>
                                 @endif
                            ...
                            @endif
                                ...
                                <table>
                                        ...
                                        @foreach ($productosTable as $producto)
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <a class="btn-like-link" href="{{ route('show.product.table', ['mesa_id' => $mesa->id, 'id' => $producto->id]) }}">Editar</a>
                                                </td>
                                                <td>
                                                    <!-- Botón para editar el producto -->
                                                <a  class="btn-like-link-dele"  href="{{ route('delete.product.table', ['mesa_id' => $mesa->id, 'id' => $producto->id]) }}">Eliminar</a>
                                    ...
                                    <tfoot>
                                        <tr>
                                            ...
                                            <td>Propina: {{ number_format(($total * env('PROPINA') )/100, 0, ',', '.') }}</td>
                                            <td colspan="3"></td>
                                        </tr>
                                    </tfoot>
                                </table>
                                ...
                                <form action="{{ route('add.product.table',['mesa_id' => $mesa->id]) }}" method="POST">
                                    ...
                                    <button type="submit" class="btn btn-primary btn-like-link">Agregar</button>
                                </form>
                            </div>
                        </div>
