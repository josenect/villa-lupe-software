    ...
    <div>
        ...
        <table>
            ...
            <tbody>
                ...
                <tr>
                    <td colspan="3" style="text-align: right;"><strong>Propina V:</strong></td>
                    <td style="text-align: right;">{{ number_format(($total * 10 )/100, 0, ',', '.') }}</td>
                    <!-- Otras celdas en esta fila -->
                </tr>
                <!-- Fila para Total -->
                <tr>
                    <td colspan="3" style="text-align: right;"><strong>Total:</strong></td>
                    <td style="text-align: right;">{{ number_format($total + (($total * 10 )/100), 0, ',', '.') }}</td>
                    <!-- Otras celdas en esta fila -->
                </tr>
            </tbody>
            <tfoot>
